...
card_1 =  html.Div([ dbc.Button(html.A("Trackers", id="tracker-button",href="/page-1"),outline=True),html.Br(),html.Br(),
            ...
            dbc.Button(html.A("R1", id="button",href="/page-2"),className="mr-1",color="warning"),
...
page_4_write=html.Div([
    html.H4('Using these you can write the commands for setting the values in the device'),
     ...
     #dbc.Row([dbc.Button("AUTOMODE", id="AUTOMODE button",color='success',outline=True,className="mr-1"),
      #   dbc.Button("MANUALMODE", id="MANUALMODE button",color='primary',outline=True,className="mr-1"),
       #  dbc.Button("STOP", id="STOP button",color='danger',className="mr-1",outline=True)])
        ]),
    dbc.Col([
      ...
      dbc.Row([html.H6("East Limit",className="mr-1",style={'color':'darkblue'}),  dcc.Input(id="input ELIM", type="text",className="mr-1"),
       ...
       dbc.Row([dbc.Button("EAST", id="EAST button",color='primary',outline=True,className="mr-1"),
...
page_7_control = html.Div([
    dbc.Row([dbc.Col([dbc.Button("AUTO", id="AUTOMODE button",className="mr-1"),html.Br(),html.Br(),
         ...
         dbc.Button("MANUAL", id="MANUALMODE button",className="mr-1"),
         ]),
         dbc.Col([dbc.Card([dbc.CardBody([dbc.CardHeader([ "Tracker Status"],style={'fontSize':'20px','fontColor':'darkblue'}),
             ...
             html.Div(["Motor Status:"],style={'fontSize':"20px"}),html.Div(d,style={'fontSize':"20px",'textAlign':'left'}),html.Br(),

             ])],style={'width':'18rem'}),
         ]),            dcc.Link(href='/page-7'),])])

page_8_status = html.Div([dbc.Row([
    dbc.Col([dbc.Card([html.Div(["Sun Angle"],style={'fontSize':"20px",'margin':'1rem','textAlign':'center'}),html.Div(b,style={'fontSize':"30px",'margin':'1rem','textAlign':'center'})],style={'width':'11rem','height':'8rem','backgroundColor':'#488AC7','height':'8rem'})])
    ...
    dbc.Col([dbc.Card([html.Div(["Tracker Mode"],style={'fontSize':"20px",'textAlign':'center','margin':'1rem'}),],style={'width':'11rem','height':'8rem','backgroundColor':'#46C7C7'}),]),
    dbc.Col([dbc.Card([html.Div(["Motor Status"],style={'fontSize':"20px",'textAlign':'center','margin':'1rem'}),],style={'width':'11rem','height':'8rem','backgroundColor':'#488AC7'}),]),
...
def update_output(valueDEV,x):
    if(x is not None):
        client.publish(pubtop,"{} WRITE:SUNTRACK".format(valueDEV))
        return 'You have published "{} write SUNTRACK"'.format(valueDEV)

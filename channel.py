...
app.layout = html.Div([navbar,content,dropdowns,data1,graph,select,dcc.Location(id="url",refresh=True)])
...
def update_output(valueDEV,valueOP,value2,x):
    ...
    #if client.publish(pubtop,"'{a}' WRITE:'{b}'_100".format(a=valueDEV,b=valueOP)):#,c=value2)):
        print("executing")
